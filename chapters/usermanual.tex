...
There are three \gls{led}s. A red one on top of the \gls{rpi2}, which is for \gls{gps} module and two on the opposite side of the \gls{usb} ports which are red and green.
