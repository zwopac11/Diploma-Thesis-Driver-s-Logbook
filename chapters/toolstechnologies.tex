...
Collaborating was the main reason why we used especially this technologies. It worked trouble-free and had option to restore older \clearpageauthor \pageauthor{Helena Adam} versions of documents, which came in handy from time to time.
\section{PHP}
\begin{wrapfigure}{r}{0.2\textwidth}
  \begin{center}
